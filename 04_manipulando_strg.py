...
print(texto_para_manipular.find("é")) # (.find("_")) nos dirá a exata posição onde o que selecionamos se encontra na string, vale lembrar que espaço em barnco tambem conta comom posição
